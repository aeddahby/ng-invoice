...
describe('Factures routing resolve service', () => {
  ...
  let resultFactures: IFactures | undefined;
  ...
  describe('resolve', () => {
    it('should return IFactures returned by find', () => {
      ...
      expect(resultFactures).toEqual({ id: 123 });
    });

    it('should return new IFactures if id is not provided', () => {
      // GIVEN
      ...
      expect(resultFactures).toEqual(new Factures());
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse({ body: null as unknown as Factures })));
      mockActivatedRouteSnapshot.params = { id: 123 };
